...
import when_how.hero.battle.listener.impl.ChargeSummoningSicknessListener;
import when_how.hero.checker.MyChecker;
import when_how.hero.common.MyException;
import when_how.hero.sdata.domain.SEffect;

public class ChargeComponent implements MyComponent {
	...
	public ChargeComponent(SEffect se, Player targetPlayer, int target) {
	...
	public void display() throws MyException {
		...
		targetServant.setSummoningSicknessListener(new ChargeSummoningSicknessListener(), se);
	}
