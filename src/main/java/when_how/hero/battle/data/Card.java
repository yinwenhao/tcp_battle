...
public class Card {
	...
	public Card(int sId) {
		...
		if (s.getChooseoneEffect() != null) {
			for (int eId : s.getChooseoneEffect()) {
				this.addChooseoneEffect(SEffectCache.CACHE.get(eId));
			}
		}
	...
	public void addChooseoneEffect(SEffect se) {
		if (chooseoneEffect == null) {
			chooseoneEffect = new ArrayList<SEffect>();
		}
		chooseoneEffect.add(se);
	}
